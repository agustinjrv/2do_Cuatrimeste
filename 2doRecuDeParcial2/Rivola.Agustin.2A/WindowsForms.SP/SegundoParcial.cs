...
namespace WindowsForms.SP
{
  public partial class SegundoParcial : Form
  {
    ...
    private void btnPunto2_Click(object sender, EventArgs e)
    {
      ...
      this.c_lapices += new Lapiz(ConsoleColor.Red, ETipoTrazo.Medio, "Faber-Castell", 20);
      this.c_lapices += new Lapiz(ConsoleColor.Blue, ETipoTrazo.Fino, "Paper Mate", 20);
      this.c_lapices += this.lapiz;

      this.c_gomas += this.goma;
      this.c_gomas += new Goma(false, "Dos banderas", 35);
    ...
    private void btnPunto9_Click(object sender, EventArgs e)
    {
      ...
      this.da.UpdateCommand.Parameters.Add("@tipo", SqlDbType.Int, 2, "tipo");
      this.da.UpdateCommand.Parameters.Add("@id", SqlDbType.Int, 2, "id");
